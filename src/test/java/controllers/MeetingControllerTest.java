...
class MeetingControllerTest {
    ...
    void getMeeting_ShouldReturnBadRequest_WhenInvalidMeetingId() throws Exception {
        // Given - nieprawidłowe ID spotkania (0)
        // When & Then - powinno zwrócić błąd walidacji @Min(1)
...
//    @Test
//    @WithMockUser(username = "test@example.com", roles = {"USER"})
//    void createMeeting_ShouldReturnCreated_WhenValidRequest() throws Exception {
//        // Given
//        CreateMeetingRequest request = new CreateMeetingRequest();
//        request.setTitle("New Meeting");
//        request.setDescription("Meeting Description");
//
...
//
//    @Test
//    void createMeeting_ShouldReturnUnauthorized_WhenUserNotLoggedIn() throws Exception {
//        // Given
//        CreateMeetingRequest request = new CreateMeetingRequest();
//        request.setTitle("New Meeting");
//        request.setDescription("Meeting Description");
...
//    @Test
//    @WithMockUser(username = "test@example.com", roles = {"USER"})
//    void createMeeting_ShouldValidateRequiredFields() throws Exception {
//        // Given - brak tytułu
//        CreateMeetingRequest request = new CreateMeetingRequest();
//        request.setDescription("Only description");
//
//        // When & Then - walidacja @NotNull na polu title
//        mockMvc.perform(post("/api/v1/meetings")
//                        .contentType(MediaType.APPLICATION_JSON)
//                        .content(objectMapper.writeValueAsString(request)))
//                .andExpect(status().isBadRequest())
...
//    @Test
//    @WithMockUser(username = "test@example.com", roles = {"USER"})
//    void getUserMeetings_ShouldReturnPaginatedResults() throws Exception {
//        // Given
...
//                .andExpect(jsonPath("$.data.content[0].title").value("Test Meeting"));
//    }
...
//
//    @Test
//    void getUpcomingPublicMeetings_ShouldWorkWithoutAuthentication() throws Exception {
//        // Given
//        List<MeetingResponse> meetings = Arrays.asList(mockMeeting);
//        when(meetingService.getUpcomingPublicMeetings()).thenReturn(meetings);
//
//        // When & Then - endpoint publiczny powinien działać bez autoryzacji
//        mockMvc.perform(get("/api/v1/meetings/public/upcoming"))
//                .andExpect(status().isOk())
//                .andExpect(jsonPath("$.success").value(true))
//                .andExpect(jsonPath("$.data").isArray());
...
//    @Test
//    @WithMockUser(username = "test@example.com", roles = {"USER"})
//    void changeMeetingStatus_ShouldReturnSuccess() throws Exception {
//        // When & Then
//        mockMvc.perform(patch("/api/v1/meetings/1/status")
//                        .param("status", "PLANOWANE"))
//                .andExpect(status().isOk())
//                .andExpect(jsonPath("$.success").value(true))
//                .andExpect(jsonPath("$.message").value("Status spotkania zmieniony pomyślnie"));
//
//        verify(meetingService).changeMeetingStatus(eq(1L), any(), eq(1L));
//    }
//
//    @Test
//    @WithMockUser(username = "test@example.com", roles = {"USER"})
//    void duplicateMeeting_ShouldReturnSuccess() throws Exception {
//        // Given
//        when(meetingService.duplicateMeeting(eq(1L), eq(1L)))
//                .thenReturn(mockMeeting);
//
//        // When & Then
//        mockMvc.perform(post("/api/v1/meetings/1/duplicate"))
//                .andExpect(status().isOk())
//                .andExpect(jsonPath("$.success").value(true))
...
//    @Test
//    @WithMockUser(username = "test@example.com", roles = {"USER"})
//    void findConflictingMeetings_ShouldReturnConflicts() throws Exception {
//        // Given
//        LocalDateTime startDate = LocalDateTime.now().plusDays(1);
//        LocalDateTime endDate = LocalDateTime.now().plusDays(2);
//
//        List<MeetingResponse> conflicts = Arrays.asList(mockMeeting);
//        when(meetingService.findConflictingMeetings(eq(1L), any(LocalDateTime.class), any(LocalDateTime.class)))
//                .thenReturn(conflicts);
//
//        // When & Then
//        mockMvc.perform(get("/api/v1/meetings/conflicts")
//                        .param("startDate", startDate.toString())
//                        .param("endDate", endDate.toString()))
//                .andExpect(status().isOk())
//                .andExpect(jsonPath("$.success").value(true))
//                .andExpect(jsonPath("$.message").value("Konflikty terminów sprawdzone pomyślnie"))
//                .andExpect(jsonPath("$.data[0].title").value("Test Meeting"));
//    }
