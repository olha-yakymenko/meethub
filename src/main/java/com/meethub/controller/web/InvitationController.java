...
//            description = "Pobiera listę wszystkich zaproszeń dla zalogowanego użytkownika i wyświetla je na stronie.")
//    public String getMyInvitations(
//            @AuthenticationPrincipal @NotNull(message = "Użytkownik musi być zalogowany") CustomUserDetails userDetails,
//            Model model) {
//
//        try {
//            log.info("Pobieranie zaproszeń dla użytkownika {}", userDetails.getId());
...
//
//        if (bindingResult.hasErrors()) {
//            log.warn("Błędy walidacji formularza odpowiedzi na zaproszenie {}: {}", participantId, bindingResult.getAllErrors());
//            redirectAttributes.addFlashAttribute("org.springframework.validation.BindingResult.invitationResponse", bindingResult);
//            redirectAttributes.addFlashAttribute("invitationResponse", form);
//            return "redirect:/invitations";
//        }
...
//
//        } catch (IllegalArgumentException e) {
//            log.warn("Nieprawidłowy status odpowiedzi '{}' dla zaproszenia {}", form.getResponse(), participantId);
//            redirectAttributes.addFlashAttribute("error", "Nieprawidłowy status odpowiedzi: " + form.getResponse());
//
//        } catch (SecurityException e) {
//            log.warn("Brak uprawnień dla użytkownika {} do odpowiedzi na zaproszenie {}", userDetails.getId(), participantId);
//            redirectAttributes.addFlashAttribute("error", "Brak uprawnień do tej operacji");
//
//        } catch (Exception e) {
//            log.error("Błąd podczas przetwarzania odpowiedzi na zaproszenie {}: {}", participantId, e.getMessage());
...
//    private String getResponseMessage(ParticipationStatus status) {
//        switch (status) {
//            case CONFIRMED: return "Zaakceptowano zaproszenie do spotkania";
//            case DECLINED: return "Odrzucono zaproszenie do spotkania";
//            default: return "Zaktualizowano status zaproszenia";
//        }
//    }
//
//    public static class InvitationResponseForm {
...
//        @Size(min = 1, max = 50, message = "Odpowiedź musi mieć od 1 do 50 znaków")
//        private String response;
//
//        @Size(max = 500, message = "Komentarz nie może przekraczać 500 znaków")
//        private String comment;
