...
public class UserProfileController {
    ...
    public String notifications(
            @Valid @ModelAttribute NotificationsListRequest request,
        ...
        if (result.hasErrors()) {
            log.warn("Błędy walidacji dla listy powiadomień: {}", result.getAllErrors());
            model.addAttribute("error", "Nieprawidłowe parametry paginacji");
