...
public class CreateLocationRequest {
    ...
    // Walidacja warunkowa
    @NotBlank(message = "Adres jest wymagany dla lokalizacji fizycznej")
    @Size(max = 1000, message = "Adres nie może przekraczać 1000 znaków")
    private String address;

    @NotBlank(message = "Miasto jest wymagane dla lokalizacji fizycznej")
    ...
    @NotBlank(message = "URL spotkania jest wymagany dla lokalizacji wirtualnej")
    ...
    @AssertTrue(message = "City is required for physical locations")
    ...
    public boolean isVirtualUrlRequired() {
    ...
    @AssertTrue(message = "Coordinates must be provided together")
